...
public class testfall_logi_kad_tvtw_016 {
...
System.setProperty("webdriver.chrome.driver", "..//Logistik//chrome//chromedriver.exe");
	...
	// *****************
		...
		// Set KAA =1
				...
				KAA.selectByValue("=1");
		// Set Product filter
				driver.findElement(By.xpath("//input[@type='text' and @name='filter[PRODUCTS]']")).sendKeys("DF8;HDF:000");
		// Set contract filter
		...
		// Search customer address
			...
			//Select TV option 
				WebElement TVCust = driver.findElement(By.xpath("(//div[@class='rechtsoben']//img[@class='spinne_icon'])[3]"));
				 ...
				 driver.findElement(By.xpath("//button[@id='outlet-001-tariffchange']")).click();
				
				 // Select Product CTWKH8TW1
				 
				 String textValue = driver.findElement(By.xpath("//div[@class='checkbox3Column02']//label[@for='id_products_TVUPGRADE_CTWKH8TW1']/strong[normalize-space()='Vodafone TV Cable [CTWKH8TW1]']")).getText();
				 //
				 //				 				 
				 if(textValue.equals("Vodafone TV Cable [CTWKH8TW1]")){
					 driver.findElement(By.xpath("//div[@class='checkbox3Column01']//input[@id='id_products_TVUPGRADE_CTWKH8TW1']")).click();
				 ...
				 //driver.findElement(By.xpath("//div[@class='buttonreihe3']//a[@id='applySelectionButton']")).click();
				 	driver.findElement(By.linkText("Auswahl übernehmen")).click();
				 ...
				 Thread.sleep(2000);
				 //Click on bankverbindung 
				 
				 driver.findElement(By.xpath("(//div[@class='rechtsoben']//img[@class='spinne_icon'])[11]")).click();
				 
				 driver.findElement(By.xpath("//td[@class='bankbutton right']/a")).click();
...
//				 driver.findElement(By.xpath("(//div[@class='buttonreihe3']/a[@id='Login.Submit'])[1]")).click();
				...
				// Check the checkbox for communication channel 
					...
					driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='dataSharingPermission']")).click();
					
					driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='advertisingPermission']")).click();
