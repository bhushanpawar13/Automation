...
public class testfall_logi_tra_ans_neu_010 {
...
//				 }  
	 ...
	 //Enter bank Details
					...
					driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='bankAccountNumber']")).sendKeys("DE45700500001586957331");
	...
	// Fill up Customer Information
				...
				driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='lastName']")).sendKeys("testfall_logi_tra_ans_neu_010");
	...
	// Click on 1V1 radio button under haus details 
				driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='buildingInstallationOffline']")).click();
