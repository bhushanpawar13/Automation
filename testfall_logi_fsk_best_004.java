...
public class testfall_logi_fsk_best_004 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		customerSearch(driver); // Search the customer in Qatools
				...
				handelAlert(driver);	// Handel Alert 
				...
				Thread.sleep(2000);
				 ...
				 customerInformation(driver);	// Fill in the customer Details 
				...
				productSelection(driver);	// Product selection flow 
	...
	// Select Future Date - Wunschlieferdatum
				...
				driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='deliveryDate']")).sendKeys("05.11.2020");
				
				marketingInformation(driver);
	
				lieferAddress(driver);
	...
	// Get the Weborder ID
		...
		public static void customerSearch(WebDriver driver) {
		
		// Find the Text box
		WebElement email =driver.findElement(By.id("userfield"));
		
	// Send username in text box 
		email.sendKeys("madhuri.patil");
		
	// Find the Password field
		WebElement password =driver.findElement(By.name("pass"));
	
	// Send password 
		password.sendKeys("Login@30");
	...
	public static void productSelection(WebDriver driver) {
		 ...
		 // Click on next button 
		WebElement Button = driver.findElement(By.xpath("//a[@id='submitButtonUseSelection']"));
		highLighterMethod(driver,Button);
		 Button.click();
	}
	
	public static void enterBankDetails(WebDriver driver) {
		...
		driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='zdMandateEmail']")).sendKeys("madhuri.patil@vodafone.com");
	...
	public static void customerInformation(WebDriver driver) {
		...
		driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='lastName']")).sendKeys("testfall_logi_kad_neu_004");
		 
		driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='firstName']")).sendKeys("Regression");
		
		driver.findElement(By.xpath("//div[@class='inputMargin']//input[@id='birthday']")).sendKeys("05.09.1989");
...
public static void marketingInformation(WebDriver driver) {
...
// Check the checkbox for communication channel 
	...
	public static void lieferAddress(WebDriver driver){
